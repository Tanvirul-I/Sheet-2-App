...
class DataSource {
  ...
  constructor(name, url, data) {
    ...
    this._key = new Column(
      ...
      TYPES.Text,
      cells,
    ); // still unclear how label and initialValue is supposed to be used -- FIX IMMEDIATELY
    ...
    for (let i = 1; i < data.length; i++) {
      ...
      this._columns.push(
        new Column(data[i][0], undefined, false, this, type, cells),
      ); // still unclear how label and initialValue is supposed to be used -- FIX IMMEDIATELY
    }
  }
