...
export default function App(props) {
	...
	useEffect(() => {
		...
		for (let i = 0; i < app.dataSources.length; i++)
			asyncGetTables(app.dataSources[i]);
			...
			<div id="app-component">
				...
				<div className="app-component-top">
					<div
						...
						id="app-component-app-details"
					>
						<h2>App Details</h2>
						<p>
							App Name: {displayAppName} { userType === "dev" ?
							...
							>
								...
								>
									...
									<IconButton
										...
										disabled={
											appName == app.name ? true : appName == "" ? true : false
										}
									>
										<DoneIcon />
									</IconButton>
													...
													onChange={(event) => {
														if (app) {
															async function asyncUpdateApp() {
																...
																if (response.data.success) {
																	setAppPublished(response.data.app.published);
																}
															}
															asyncUpdateApp();
														}
